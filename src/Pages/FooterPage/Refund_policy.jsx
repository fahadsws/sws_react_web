...
const Refund_policy = () => {
    return (
        <>
            <Helmet>
                <title>
                    Cancellation & Refund Policy | Soham Web Solution - Website Development Company India
                </title>
                <meta charset="UTF-8" />
                ...
                <meta property="og:title" content="Cancellation &amp; Refund Policy | Soham Web Solution - Website Development Company India" />
                <meta property="og:description" content="Last updated on 22-11-2023" />
                <meta property="og:url" content="https://sohamsolution.com/cancellation-refund-policy/" />
