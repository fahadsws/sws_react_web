...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Soham Web Solution - Website Development Company India</title>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="format-detection" content="telephone=no" />
        <meta name="description" content="Last updated on 21-11-2023" />
        <meta name="robots" content="follow, noindex" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Privacy Policy | Soham Web Solution - Website Development Company India" />
        <meta property="og:url" content="https://sohamsolution.com/privacy-policy/" />
      ...
      <Box className="flex-center">
        <Box className="container flex-center">
            ...
            <Box className="flex-center-column privacy_man"  >
              ...
              <Box className="terms_conditon_content  flex-coulmn ">
              ...
              <Typography className='terms_conditon_heading'>Who do we share your data with </Typography>
              ...
              <Typography className="terms_conditon_content">We may retain your information or data (i) for as long as we are providing goods and services to you; and (ii) as permitted under applicable law, we may also retain your data or information even after you terminate the business relationship with us. However, we will process such information or data in accordance with applicable laws and this Policy</Typography>
