...
const ServiceContaint = () => {
    useEffect(() => {
        const parentContainers = document.querySelectorAll('.service_container_tow_man, .service_container_one');

        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    const animations = entry.target.querySelectorAll('.service_animtion1, .service_animtion2');
            ...
            <Box className="service_primary_section flex-center" >
                <Box className="service-man flex-center-coulmn "  >
                    ...
                    <Box className="service_container_one container flex-between-wrap"  >
                        <Box className="devlopment-text service_animtion2" >
                        ...
                        <img className='service_img service_animtion1' src={Php} alt="" />
                    ...
                    <Box className="service_container_tow_man flex-center ">
                        ...
                        <img className='service_img service_animtion2' src={Wordpress} alt="" />

                            <Box className="devlopment-text service_animtion1">
                    ...
                    <Box className="service_container_one container flex-between-wrap" >
                        ...
                        <img className='service_img service_animtion1' src={Shopify} alt="" />
                    ...
                    <Box className="service_container_tow_man flex-center">
                        <Box className="service_container_two container flex-between-wrap"  >
                        <img className='service_img service_animtion2' src={Webdesigner} alt="" />
                    ...
                    <Box className="service_container_one container flex-between-wrap"  >
                        ...
                        <img className='service_img service_animtion1' src={Graphic} alt="" />
                    ...
                    <Box className="service_container_tow_man  flex-center">
                        ...
                        <img className='service_img service_animtion2' src={Ecoomerce} alt="" />

                            <Box className="devlopment-text service_container_animtion service_animtion1" >
                    ...
                    <Box className="service_container_one container flex-between-wrap"  >
                        ...
                        <img className='service_img service_animtion1' src={Laraval} alt="" />
                    </Box>
                    {/* 8 */}
                    <Box className="service_container_tow_man flex-center">
                        <Box className="service_container_two container flex-between-wrap" >

                        <img className='service_img service_animtion2' src={Codeigniter} alt="" />
                    ...
                    <Box className="service_container_one container flex-between-wrap"   >
                        ...
                        <img className='service_img service_animtion1' src={Native} alt="" />
                    </Box>
                </Box>
