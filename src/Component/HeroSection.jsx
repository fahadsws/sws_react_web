...
import Latest from "../../assets/HomePage_img/homepage.webp"
import Whatsapp from "../../assets/HomePage_img/whatsapp1.svg"
    ...
    return (
        <Box className="home flex-center " flexDirection={'column'}>
            ...
            <Box className="home-lastSection flex-between container"   >
                ...
                <Box  className="flex-between socal_icon_hero_section"  >
                        <a className='hero_icon_ancor' target="_blank" href="https://www.facebook.com/sohamsolution/">
                            <FaFacebookF className='text_color_blue icon_hero' fontSize={18} />
                        </a>

                        <a className='hero_icon_ancor' target="_blank" href='https://in.linkedin.com/company/soham-web-solution'>
                            <FaLinkedinIn className='text_color_blue icon_hero' fontSize={18} />
                        </a>

                        <a className='hero_icon_ancor' target="_blank" href="https://www.instagram.com/sohamwebsolution/">
                            <AiFillInstagram className='text_color_blue icon_hero' fontSize={18} />
                        </a>
                </Box>
            </Box>
        </Box>
